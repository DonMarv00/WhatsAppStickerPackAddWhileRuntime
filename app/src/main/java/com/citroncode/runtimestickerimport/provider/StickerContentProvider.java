package com.citroncode.runtimestickerimport.provider;
...
public class StickerContentProvider extends ContentProvider {
    ...
    public static Uri AUTHORITY_URI = new Uri.Builder().scheme(StickerContentProvider.CONTENT_SCHEME).authority(Config.CONTENT_PROVIDER_AUTHORITY).appendPath(StickerContentProvider.METADATA).build();
    ...
    public boolean onCreate() {
        ...
        final String authority = Config.CONTENT_PROVIDER_AUTHORITY;
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (matchCode) {
            case METADATA_CODE:
                return "vnd.android.cursor.dir/vnd." + Config.CONTENT_PROVIDER_AUTHORITY + "." + METADATA;
            case METADATA_CODE_FOR_SINGLE_PACK:
                return "vnd.android.cursor.item/vnd." + Config.CONTENT_PROVIDER_AUTHORITY + "." + METADATA;
            case STICKERS_CODE:
                return "vnd.android.cursor.dir/vnd." + Config.CONTENT_PROVIDER_AUTHORITY + "." + STICKERS;
